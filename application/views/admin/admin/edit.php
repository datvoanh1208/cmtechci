...
<div class="wrapper">
	<div class="widget">
        ...
        <fieldset>
            ...
            <div class="formRight">
                    <span class="oneTwo"><input name="username" id="param_username" value="<?php echo $info->username ?>" autocheck="true" type="text"></span>
                    <span name="name_autocheck" class="autocheck"></span>
            ...
            <div class="formRight">
                    <span class="oneTwo"><input name="password" id="param_password" _autocheck="true" type="password">
                        <p>Nếu cập nhật thì mới nhập giá trị</p>
                    </span>
                    <span name="name_autocheck" class="autocheck"></span>
