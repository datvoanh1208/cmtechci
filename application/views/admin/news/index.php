	...
	<div class="widget">
		...
		<table class="sTable mTable myTable" id="checkAll" width="100%" cellspacing="0" cellpadding="0">
				...
				<form class="list_filter form" action="<?php echo admin_url('news'); ?>" method="get">
					<table width="80%" cellspacing="0" cellpadding="0"><tbody>
						<tr>
							...
							<td class="item" style="width:155px;"><input name="title" value="<?php echo $this->input->get('title'); ?>" id="filter_title" style="width:155px;" type="text"></td>
							
							
							
							<td style="width:150px">
							<input class="button blueB" value="Lọc" type="submit">
                                     <input class="basic" value="Reset" onclick="window.location.href = '<?php echo admin_url('news') ?>'; " type="reset">
							</td>
			...
			<tbody class="list_item">
					...
					<div class="f11">
					  Xem: <?php echo $row->count_view ?>					</div>
					...
					<td class="option textC">
                        ...
                        <a href="news/view/9.html" target="_blank" class="tipS" title="Xem chi tiết bài viêt">
